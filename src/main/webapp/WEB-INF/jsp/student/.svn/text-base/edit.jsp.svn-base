...
<html>
<head>
    <title><fmt:message key="student.edit.title"/></title>
    <link rel="stylesheet" type="text/css" href="<c:url value='/resources/css/students.css'/>" />
</head>
<body>
    <div id="content">
        <h1><fmt:message key="student.edit.heading"/></h1>
        <c:if test="${empty studentError}">
        <form:form id="registration" method="post" commandName="studentForm">
        <ul>
            <li>
                <label for="firstName"><fmt:message key="student.edit.form.firstname"/></label>
                <form:input path="firstName"/>
                <p>&nbsp;<form:errors path="firstName"/></p>
            </li>
            <li>
                <label for="lastName"><fmt:message key="student.edit.form.lastname"/></label>
                <form:input path="lastName"/>
                <p>&nbsp;<form:errors path="lastName"/></p>
            </li>
            <li>
                <label for="group"><fmt:message key="student.edit.form.group"/></label>
                <form:select path="group" >
                    <option value=""><fmt:message key="student.edit.form.group.choose"/></option>
            ...
            <li>
                <label for="subDepartment"><fmt:message key="student.edit.form.subdepartment"/></label>
                <form:select path="subDepartment" >
                    <option value=""><fmt:message key="student.edit.form.subdepartment.choose"/></option>
            ...
            <li>
                <label for="isHead"><fmt:message key="student.edit.form.ishead"/></label>
                <div id="head">
                <c:choose>
            ...
            <li class="center">
                ...
                <input id="cancelForm" type="button" name="cancel" value="<fmt:message key='student.edit.form.cancel'/>" onclick="location.href='${cookah.returnPath}';"  />
                <input id="saveForm" type="submit" name="submit" value="<fmt:message key='student.edit.form.ok'/>" />
                <p>&nbsp;</p>
            </li>
        </ul>
        </form:form>
